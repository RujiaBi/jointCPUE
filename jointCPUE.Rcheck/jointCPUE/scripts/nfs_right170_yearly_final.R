# Final yearly workflow for NFS data east of 170E.
...
required_objects <- c("dd_right_170", "year_lookup_right_170")
...
dd <- dd_right_170
year_lookup <- year_lookup_right_170
